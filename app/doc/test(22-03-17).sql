...
CREATE TABLE `member` (
  ...
  `m_img` varchar(500) NOT NULL COMMENT '회원프로필사진',
...
CREATE TABLE `store` (
  ...
  `hour` varchar(30) NOT NULL COMMENT '영업시간',
...
CREATE TABLE `owner_member` (
  `mno` int(11) NOT NULL COMMENT '회원번호',
  `store_no` int(11) NOT NULL COMMENT '주점번호',
  `img` varchar(500) NOT NULL COMMENT '프로필사진',
...
CREATE TABLE `report` (
  ...
  `target_no` varchar(1) NOT NULL COMMENT '피신고대상번호',
