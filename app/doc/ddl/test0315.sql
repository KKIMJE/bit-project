...
ALTER TABLE store
  MODIFY COLUMN store_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '주점번호';
...
ALTER TABLE alcohol_management
  MODIFY COLUMN drink_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '음주번호';
...
ALTER TABLE reservation
  MODIFY COLUMN reservation_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '예약번호';
...
ALTER TABLE inquiry
  MODIFY COLUMN inq_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '문의번호';
...
ALTER TABLE store_menu
  MODIFY COLUMN store_menu_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '메뉴번호';
...
ALTER TABLE alcohol_detail
  MODIFY COLUMN alcohol_detail_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '술번호';
...
ALTER TABLE alcohol_type
  MODIFY COLUMN alcohol_type_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '주종번호';
...
ALTER TABLE store_type
  MODIFY COLUMN store_type_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '주점유형번호';
...
ALTER TABLE community
  MODIFY COLUMN community_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '커뮤니티번호';
...
ALTER TABLE report
  MODIFY COLUMN repo_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '신고하기번호';
...
ALTER TABLE party_board
  MODIFY COLUMN party_board_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '모임게시판번호';
...
CREATE TABLE party (
  ...
  meeting_date  DATETIME    NOT NULL COMMENT '모임일시', -- 모임일시
...
ALTER TABLE party
  MODIFY COLUMN party_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '모임번호';
...
ALTER TABLE review_img
  MODIFY COLUMN review_img_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '사진번호';
...
ALTER TABLE menu_img
  MODIFY COLUMN menu_img_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '사진번호';
...
ALTER TABLE store_img
  MODIFY COLUMN store_img_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '사진번호';
...
CREATE TABLE party_comment (
  party_comment_no       INTEGER   NOT NULL COMMENT '모임댓글번호', -- 모임댓글번호
  mno                    INTEGER   NOT NULL COMMENT '회원번호', -- 회원번호
  party_no               INTEGER   NOT NULL COMMENT '모임번호', -- 모임번호
  party_comment_contents TEXT      NOT NULL COMMENT '내용', -- 내용
  comment_date           TIMESTAMP NOT NULL COMMENT '작성일', -- 작성일
  update_date            TIMESTAMP NOT NULL COMMENT '수정일' -- 수정일
)
COMMENT '모임댓글';
